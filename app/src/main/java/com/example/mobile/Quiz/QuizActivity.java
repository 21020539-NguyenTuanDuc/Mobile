package com.example.mobile.Quiz;
...
import com.example.mobile.Adapter.NoScrollRecyclerView;
...
import com.example.mobile.Util.Utils;
import com.example.mobile.databinding.ActivityQuizBinding;
...
//        textViewScoreValue.setText("" + HomeFragment.scoreModel.getScore());
        textViewScoreValue.setText("" + MainActivity.currentUser.getCoin());
...
//        }
    ...
    private void updateScore() {
        MainActivity.currentUser.setCoin(
                MainActivity.currentUser.getCoin()
                        + setCoinForCorrectAnswer(countCorrectAnswer)
        );
        Utils.updateScore(MainActivity.currentUser.getCoin());
//                     onBackPressed();
    }
                    ...
                    if (quizAdapter.choseAnswerList.get(quizCount - 1) > 0) {
                        ...
                        handler.postDelayed(new Runnable() {
                            ...
                            public void run() {
                                ...
                                textViewScoreValue.setText(Long.toString(
                                        MainActivity.currentUser.getCoin()
                                                + setCoinForCorrectAnswer(countCorrectAnswer))
                                );
    ...
    private void getQuizList(String date_id) {
        quizModelList.clear();
        db.collection("Quiz")
                .whereEqualTo("date_id", date_id)
                .get()
...
//                        timer.start();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Log.e("Failed Getting Quiz", date_id);
                    }
                });
...
//        TextView textViewTotalCurrentCoins = (TextView) dialog.findViewById(R.id.totalCurrentCoins);
        ...
        textViewCoinTotal.setText(
                Long.toString(MainActivity.currentUser.getCoin())
        );
