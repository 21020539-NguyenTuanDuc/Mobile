...
import com.example.mobile.Model.NotificationModel;
import com.example.mobile.Model.ScoreModel;
...
public class Utils {
    ...
    public static void updateScore(long newCoin) {
        FirebaseFirestore.getInstance().collection("User")
                ...
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Log.e("Update score failed", e.getMessage());
                    }
                });
    }
