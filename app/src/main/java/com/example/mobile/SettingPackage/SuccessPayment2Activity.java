...
import com.example.mobile.databinding.ActivitySuccessPayment2Binding;
import com.google.firebase.firestore.FirebaseFirestore;

public class SuccessPayment2Activity extends AppCompatActivity {

    ActivitySuccessPayment2Binding binding;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivitySuccessPayment2Binding.inflate(getLayoutInflater());
        ...
        binding.homeScreenButton.setOnClickListener(v -> {
            ...
            startActivity(new Intent(SuccessPayment2Activity.this, MainActivity.class));
            finishAffinity();
        });
